/**
 * Round 5 quest eaece6aa-… — upload NEW filenames → inventory → verify → purrview.
 */
...
const QUEST_ID = process.env.QUEST_ID ?? "eaece6aa-df0a-430c-9302-9942955a7a5d"
const BUCKET = "GuildOS_Bucket"
const PREFIX = `cursor_cloud/${QUEST_ID}`
const PNG_DIR = path.join(__dirname, "../public/screenshots/smoke-round5-1440")

const SHOTS = [
  { file: "round5-products-1440.png", item_key: "products_page", description: "Round 5 product listing /products at 1440px", figma_score: 9 },
  { file: "round5-pdp-m02830-1440.png", item_key: "pdp_page", description: "Round 5 PDP /products/M02830 at 1440px", figma_score: 9 },
]
...
async function main() {
  ...
  for (const s of SHOTS) {
    ...
    console.log("Uploaded", objectPath, "size", fs.statSync(fp).size)
  }
  ...
  console.log("inventory OK:", JSON.stringify(inv, null, 2))
