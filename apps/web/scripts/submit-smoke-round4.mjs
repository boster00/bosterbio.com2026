/**
 * Round 4 — BosterBio smoke PLP/PDP: upload → quests.inventory → verify → purrview.
 *   QUEST_ID=331dbedf-0005-4d44-b0fe-9991ab9ea73b node scripts/submit-smoke-round4.mjs
 */
...
const QUEST_ID = process.env.QUEST_ID ?? "331dbedf-0005-4d44-b0fe-9991ab9ea73b"
