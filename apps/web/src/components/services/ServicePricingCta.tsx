...
type Props = {
  /** Short label for the service, e.g. "Custom antibody projects" */
  serviceLabel: string
  primaryHref?: string
  primaryLabel?: string
}
...
export function ServicePricingCta({
  ...
  return (
    <section
      className="mt-14 rounded-2xl border-2 border-accent/40 bg-gradient-to-br from-accent-soft via-white to-brand-tint p-8 text-center shadow-card md:p-10"
